...
// Get the modal
var divEventideModal = document.getElementById("divEventideModal");

// Get the button that opens the modal
var btn = document.getElementById("btnShowEventideModal");
...
btn.onclick = function() {
  divEventideModal.style.display = "block";
}

// When the user clicks on <span> (x), close the modal
span.onclick = function() {
  divEventideModal.style.display = "none";
}

// When the user clicks anywhere outside of the modal, close it
window.onclick = function(event) {
  if (event.target == divEventideModal) {
    divEventideModal.style.display = "none";
  }
} 